...
INSERT INTO `dosen` (`id`, `nidn`, `nama`, `gelar`, `email`, `id_user`) VALUES
(21, '1001', 'Dr. Ahmad Fauzi', 'S.Kom.,M.Kom', 'ahmad@kampus.ac.id', 22),
(22, '1002', 'Dr. Budi Santoso', 'S.Kom.,M.Kom', 'budi@kampus.ac.id', 23),
(23, '1003', 'Dr. Citra Dewi', 'S.Kom.,M.Kom', 'citra@kampus.ac.id', 24),
(24, '1004', 'Dr. Dedi Pratama', 'S.Kom.,M.Kom', 'dedi@kampus.ac.id', 25);
